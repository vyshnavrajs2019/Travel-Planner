        ...
        for i in places:
            ...
            for j in neighbourItemRatings.index:
                if userItemRatingMatrix.loc[j,i]>0:
                   predictedRating += (userItemRatingMatrix.loc[j,i])*nearestNeighbours.loc[j,'Similarity']
...
def topNRecommendations(activeUser,N,places,watched):
    try:
        ...
        topRecommendationTitles=placeInfo.loc[[i-1 for i in topRecommendations.index]]
    except ZeroDivisionError:
        print("You can't divide by zero!")
